...
- Contact: Users can use `contact us` option to directly message us using the form provided.
...
To introduce Technology Business Incubator, open any web browser and navigate to the following URL: https://dakshbamola.github.io/TBI_project/

## Login

Enter a predefined username (user) and password (password) to log in on the login page.
